...
- To remove accidental Playwright/Contract event artifacts, use `scripts/cleanup-playwright-contract-events.sql` (preview mode by default; guardrails require draft-only matches and set `@apply = 1` before deletes run).
